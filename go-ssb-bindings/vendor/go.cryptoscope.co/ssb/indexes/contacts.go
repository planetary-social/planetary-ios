...
func OpenContacts(log kitlog.Logger, r repo.Interface) (graph.Builder, librarian.SinkIndex, error) {
	...
	// TODO: closing
	_, serve, err := repo.OpenBadgerIndex(r, FolderNameContacts, f)
	if err != nil {
