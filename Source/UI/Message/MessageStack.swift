...
/// A stack of messages. The primary purpose of this view is to be used inside a ScrollView.
/// For most cases, consider using MessageList instead because it already integrates a ScrollView.
