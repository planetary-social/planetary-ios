//
//  ConnectedPeerListController.swift
//  Planetary
//
...
/// A Router that can change scenes for `ConnectedPeerListController`
protocol ConnectedPeerListRouter: AlertRouter {
    func showProfile(for identity: Identity)
}

/// An enumeration of the errors produced by `ConnectedPeerListController`
...
class ConnectedPeerListController: ConnectedPeerListViewModel {
