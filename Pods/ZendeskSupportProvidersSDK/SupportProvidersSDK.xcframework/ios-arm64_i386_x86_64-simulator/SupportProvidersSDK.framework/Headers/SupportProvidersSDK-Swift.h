...
#ifndef SUPPORTPROVIDERSSDK_SWIFT_H
#define SUPPORTPROVIDERSSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SupportProvidersSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19SupportProvidersSDK17DispatcherAdapter")
...
SWIFT_CLASS("_TtC19SupportProvidersSDK13HTMLSanitizer")
...
@interface ZDKLegacyRequestStorageMigrator (SWIFT_EXTENSION(SupportProvidersSDK))
- (void)checkAndMigrateOldTicketIds;
@end


SWIFT_CLASS_NAMED("ListArticleQuery")
@interface ZDKListArticleQuery : NSObject
@property (nonatomic, readonly) NSInteger perPage;
@property (nonatomic, readonly) NSInteger page;
- (nonnull instancetype)initWithPerPage:(NSInteger)perPage page:(NSInteger)page OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface ZDKRequestBlips (SWIFT_EXTENSION(SupportProvidersSDK))
...
@interface ZDKRequestForStorage (SWIFT_EXTENSION(SupportProvidersSDK))
...
@interface ZDKRequestStorage (SWIFT_EXTENSION(SupportProvidersSDK))
...
SWIFT_CLASS("_TtC19SupportProvidersSDK29ZDKAttachmentSettingsProvider")
...
SWIFT_CLASS("_TtC19SupportProvidersSDK28ZDKContactUsSettingsProvider")
...
SWIFT_CLASS("_TtC19SupportProvidersSDK32ZDKConversationsSettingsProvider")
...
SWIFT_CLASS("_TtC19SupportProvidersSDK29ZDKHelpCenterSettingsProvider")
...
@interface ZDKRequestProvider (SWIFT_EXTENSION(SupportProvidersSDK))
...
SWIFT_CLASS("_TtC19SupportProvidersSDK26ZDKSupportSettingsProvider")
...
SWIFT_CLASS("_TtC19SupportProvidersSDK30ZDKTicketFormsSettingsProvider")
