...
@implementation NSData (PHG_GZIP)

- (NSData *)phg_gzippedDataWithCompressionLevel:(float)level
{
...
- (NSData *)phg_gzippedData
{
    return [self phg_gzippedDataWithCompressionLevel:-1.0f];
}

- (BOOL)phg_isGzippedData
{
