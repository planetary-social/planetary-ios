...
@interface PHGStoreKitCapturer ()

@property (nonatomic, readonly) PHGPostHog *posthog;
...
@implementation PHGStoreKitCapturer

+ (instancetype)captureTransactionsForPostHog:(PHGPostHog *)posthog
{
    return [[PHGStoreKitCapturer alloc] initWithPostHog:posthog];
}
