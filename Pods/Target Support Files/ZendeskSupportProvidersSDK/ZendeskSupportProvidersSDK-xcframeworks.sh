...
install_xcframework "${PODS_ROOT}/ZendeskSupportProvidersSDK/SupportProvidersSDK.xcframework" "SupportProvidersSDK" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
